...
namespace Content.Goobstation.Client.ServerCurrency.UI
{
    ...
    public sealed partial class CurrencyWindow : DefaultWindow
    {
        ...
        public event Action<int, int, RouletteMode, bool>? OnSpinRoulette;
        ...
        private void OpenRouletteMenu()
        {
            if (_rouletteWindow == null || _rouletteWindow.Disposed)
            {
                ...
                _rouletteWindow.SpinRequested += (bet, spinId, mode, fastSpin) => OnSpinRoulette?.Invoke(bet, spinId, mode, fastSpin);
            }
