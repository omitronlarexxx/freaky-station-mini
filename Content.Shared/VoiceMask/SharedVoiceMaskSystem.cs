...
public sealed class VoiceMaskBuiState : BoundUserInterfaceState
{
    ...
    public VoiceMaskBuiState(string name, string voice, string bark, float pitch, string? verb, ProtoId<JobIconPrototype>? jobIcon) // CorvaxGoob-TTS & GabyStation -> Radio icons
    {
        Name = name;
        Verb = verb;
